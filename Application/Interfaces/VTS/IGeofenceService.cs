...
public interface IGeofenceService
{
    ...
    Task<GeofenceListUiResponseDto> GetZones(int page, int pageSize, string? search = null);
    Task<PagedResultDto<GeofenceDto>> GetPagedAsync(int page, int pageSize, string? search = null);
