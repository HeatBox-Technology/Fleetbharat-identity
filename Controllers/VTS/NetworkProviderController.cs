...
public class NetworkProviderController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(NetworkProviderDto dto)
    {
    ...
    public async Task<IActionResult> GetList(
        ...
        string? search = null)
    {
        var result = await _service.GetProviders(page, pageSize, search);
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, NetworkProviderDto dto)
    {
