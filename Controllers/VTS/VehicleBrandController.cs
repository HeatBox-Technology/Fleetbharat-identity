...
public class VehicleBrandController : ControllerBase
{
    ...
    public VehicleBrandController(IVehicleBrandService service)
    {
        _service = service;
    }

    [HttpPost]
    public async Task<IActionResult> Create(VehicleBrandDto dto)
    {
    ...
    public async Task<IActionResult> GetList(
        ...
        string? search = null)
    {
        var result = await _service.GetBrands(page, pageSize, search);
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, VehicleBrandDto dto)
    {
