...
public class VehicleDeviceMapController : ControllerBase
{
    ...
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateVehicleDeviceMapDto dto)
    {
    ...
    /// </summary>
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateVehicleDeviceMapDto dto)
    {
    ...
    /// </summary>
    [HttpPost("bulk")]
    public async Task<IActionResult> BulkUpload([FromBody] List<CreateVehicleDeviceMapDto> items)
    {
